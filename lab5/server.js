...
async function startApollo() {
    const apolloServer = new ApolloServer({
        ...
        context: ({ req, res }) => {
            ...
            try {
                const data = require('jsonwebtoken').verify(token, '123123');
                return { req, res, user: { id: data.id, login: data.login } };
            } catch {
...
// Сохраняем REST для загрузок и обратной совместимости при необходимости
